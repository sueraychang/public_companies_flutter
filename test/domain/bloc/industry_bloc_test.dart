...
void main() {
  ...
  setUp(() {
    industryBloc = IndustryBloc(repo: repo);
  });

  group('IndustryBloc', () {
    test('Initial state is Loading', () {
      expect(industryBloc.state, isA<Loading>());
    });

    blocTest(
      'emits industries and the counts of company in each of it when the event GetIndustries is added',
      setUp: () {
    ...
    blocTest(
      'emits error when failed to get industries',
      setUp: () {
        when(repo.getIndustries())
