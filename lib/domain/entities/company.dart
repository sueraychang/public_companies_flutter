...
class Company with _$Company {
  ...
  const factory Company({
    ...
    @HiveField(11) @JsonKey(name: '普通股每股面額') @Default('') String parValuePerShare,
    @HiveField(12) @JsonKey(name: '私募股數') @Default('') String privateEquilty,
    @HiveField(13) @JsonKey(name: '特別股') @Default('') String preferredStock,
    @HiveField(14) @JsonKey(name: '網址') @Default('') String website,
    @HiveField(15) @JsonKey(name: '已發行普通股數或TDR原股發行股數') @Default('') String authorizedStock,
  }) = _Company;
