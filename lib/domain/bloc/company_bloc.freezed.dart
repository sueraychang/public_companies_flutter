...
/// @nodoc
abstract class $CompanyStateCopyWith<T, E, $Res> {
  factory $CompanyStateCopyWith(
          CompanyState<T, E> value, $Res Function(CompanyState<T, E>) then) =
      _$CompanyStateCopyWithImpl<T, E, $Res, CompanyState<T, E>>;
}

/// @nodoc
class _$CompanyStateCopyWithImpl<T, E, $Res, $Val extends CompanyState<T, E>>
    implements $CompanyStateCopyWith<T, E, $Res> {
...
class __$$LoadingImplCopyWithImpl<T, E, $Res>
    extends _$CompanyStateCopyWithImpl<T, E, $Res, _$LoadingImpl<T, E>>
...
class _$LoadingImpl<T, E> implements Loading<T, E> {
  ...
  @override
  String toString() {
    return 'CompanyState<$T, $E>.loading()';
  }
...
abstract class Loading<T, E> implements CompanyState<T, E> {
...
class __$$SuccessImplCopyWithImpl<T, E, $Res>
    extends _$CompanyStateCopyWithImpl<T, E, $Res, _$SuccessImpl<T, E>>
...
class _$SuccessImpl<T, E> implements Success<T, E> {
  ...
  @override
  String toString() {
    return 'CompanyState<$T, $E>.success(data: $data)';
  }
...
abstract class Success<T, E> implements CompanyState<T, E> {
...
class __$$FailureImplCopyWithImpl<T, E, $Res>
    extends _$CompanyStateCopyWithImpl<T, E, $Res, _$FailureImpl<T, E>>
...
class _$FailureImpl<T, E> implements Failure<T, E> {
  ...
  @override
  String toString() {
    return 'CompanyState<$T, $E>.failure(e: $e)';
  }
...
abstract class Failure<T, E> implements CompanyState<T, E> {
